...
const ReservationDetails = ({ 
    ...
    // Old table column definitions removed in favor of responsive cards
                                                    ...
                                                    <div key={venue.reservation_venue_id || venue.venue_id} className="p-3 border rounded-lg flex items-start justify-between">
                                                        <div className="flex items-start gap-2 min-w-0">
                                                            ...
                                                            <div className="min-w-0">
                                                                <p className="font-medium text-gray-800 break-words">{venue.venue_name}</p>
                                                            </div>
                                                        </div>
                                                        {showAvailability && (
                                                            <Tag className="shrink-0" color={checkResourceAvailability('venue', venue.venue_id, reservationDetails.availabilityData) ? 'green' : 'red'}>
                                                                {checkResourceAvailability('venue', venue.venue_id, reservationDetails.availabilityData) ? 'Available' : 'Not Available'}
                                                            </Tag>
                                                        )}
                                                    </div>
                                                ))}
