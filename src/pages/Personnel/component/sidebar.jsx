...
const Sidebar = () => {
  ...
  // Fetch notifications (unified with User Sidebar)
  const fetchNotifications = async () => {
    try {
      ...
      if (data.status === 'success') {
        ...
        console.warn('Notification fetch returned non-success status:', data);
      }
    } catch (error) {
  ...
  // Mark notifications as read (unified with User Sidebar)
  ...
  // Render notifications popover (same UI pattern as Admin)
