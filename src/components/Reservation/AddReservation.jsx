  ...
  <footer className="px-4 sm:px-6 py-4 bg-gray-50 border-t border-gray-100">
    <nav className="flex flex-col gap-4 w-full">
      {/* Top row: Previous and Next/Submit buttons */}
      <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-3 w-full">
        {/* Previous Button */}
        <div className="w-full sm:w-auto flex justify-center sm:justify-start">
          <AntButton
            ...
            onClick={handleBack}
            size="large"
            className="p-button-outlined w-full sm:w-auto flex items-center justify-center"
        ...
        <div className="w-full sm:w-auto flex justify-center sm:justify-end">
          {currentStep === 4 ? (
            <AntButton
              ...
              size="large"
              className="p-button-success bg-green-500 hover:bg-green-600 border-green-500 w-full sm:w-auto flex items-center justify-center"
              disabled={loading}
            >
              <span className="ml-1">
            ...
            <AntButton
              ...
              onClick={handleNext}
              size="large"
              className="p-button-primary bg-gradient-to-r from-lime-600 to-green-600 hover:from-lime-700 hover:to-green-700 border-lime-600 text-white w-full sm:w-auto flex items-center justify-center"
            >
      ...
      {currentStep > 0 && (
        <div className="w-full flex justify-center">
          <AntButton
            ...
            onClick={resetForm}
            size="large"
            className="p-button-outlined border-orange-500 text-orange-600 hover:bg-orange-50 w-full sm:w-auto flex items-center justify-center"
          >
            <span className="hidden sm:inline ml-1">Reset Form</span>
          </AntButton>
        </div>
      )}
    </nav>
